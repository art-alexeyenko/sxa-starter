...
import client from 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/src/lib/sitecore-client';
import Image from 'next/image';
import * as FEAAS from '@sitecore-feaas/clientside/react';
import nextConfig from 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/next.config';
import { pageView } from '@sitecore-cloudsdk/events/browser';
import config from 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/sitecore.config';
...
const importMap = [
  ...
  {
    module: 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/src/lib/sitecore-client',
    exports: [
  ...
  {
    module: 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/next.config',
    exports: [
  ...
  {
    module: 'C:/Work/sxa-starter/headapps/content-sdk/nextjs-starter/sitecore.config',
    exports: [
